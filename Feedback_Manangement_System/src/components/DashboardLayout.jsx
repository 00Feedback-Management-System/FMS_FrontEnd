...
function DashboardLayout() {
            ...
            <Box sx={{ flexGrow: 1, overflowY: "auto" }}>
                <List>
                    ...
                    {currentRole?.toLowerCase() === "admin" && (
                        <>
                            <ListItemButton onClick={() => handleNavigate("/app/feedback-dashboard")}>
                                <ListItemIcon>
                                    <DashboardIcon />
                                </ListItemIcon>
                                Feedback Dashboard
                            ...
                            <Collapse in={openFeedbackSummary}>
                                <List>
                                    ...
                                    <ListItemButton
                                        onClick={() => navigate("/app/per-faculty-feedback-summary")}
                                        sx={{ pl: 8 }}
                                    >
    ...
    return (
        <Box sx={{ display: "flex" }}>
            {/* AppBar for Mobile */}
            {isMobile && (
                <AppBar position="fixed" sx={{ zIndex: 1201, height: 64, justifyContent: "center" }}>
